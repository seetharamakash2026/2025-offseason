...
public class DriveConstants {
    ...
    public static final double preciseTranslationkP = 6;
    ...
    public static final PIDController preciseTranslationController = new PIDController(preciseTranslationkP,
            preciseTranslationkI, preciseTranslationkD);
    public static final PIDController preciseRotationController = new PIDController(preciseRotationkP,
            preciseRotationkI, preciseRotationkD);
